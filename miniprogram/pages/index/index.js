...
Component({
  ...
  methods: {
    ...
    findToolById: function (toolId) {
      return this.data.recommendTools.find(function (tool) {
          ...
          switch (_a.label) {
            ...
            case 1:
              ...
              return [4 /*yield*/ , Promise.resolve().then(function () {
                return __importStar(require('../../utils/dataManager'));
              })];
            case 2:
            ...
            case 3:
              result = _a.sent();
              if (result.success) {
                toolIndex = this.data.recommendTools.findIndex(function (t) {
                  return t.id === tool.id;
                });
                if (toolIndex !== -1) {
